                ...
                <ul class="footer-contacts d-inline-block d-sm-block">
                  <li>
                    <div class="unit">
                      ...
                      <div class="unit-body"><a class="link-phone" href="tel:+57 319-398-1055">+57 319-398-1055 </a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit">
                      <div class="unit-left"><span class="icon fa fa-envelope"></span></div>
                      <div class="unit-body"><a class="link-aemail" href="mailto:chairatravel2024@gmail.com">chairatravel2024@gmail.com</a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit">
                      <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                      <div class="unit-body"><a class="link-location" href="https://www.google.com/maps/@1.3342844,-74.8438663,1329m/data=!3m1!1e3?entry=ttu&g_ep=EgoyMDI1MDEwMS4wIKXMDSoJLDEwMjExMjMzSAFQAw%3D%3D">Cartagena Del Chairá, Caquetá
                      </a></div>
                    </div>
                  </li>
                </ul>
          ...
          <div class="col-sm-11 col-md-7 col-lg-5 col-xl-4">
            <div class="oh-desktop">
              <div class="wow slideInLeft" data-wow-delay="0s">
                ...
                <div class="group-md group-middle justify-content-sm-start"><a class="button button-lg button-primary button-ujarak" href="#">Ponte en contacto con nosotros</a></div>
              </div>
            </div>
          </div>
        </div>
